<?php
if ($_POST['r'] == 'capture-lessons-add-question8' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
	...
	', $name_lesson_select);
} else if ($_POST['r'] == 'capture-lessons-add-question8' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

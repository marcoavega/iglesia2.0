...
if ($_POST['r'] == 'capture-lessons-edit-question6' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-edit-question6' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

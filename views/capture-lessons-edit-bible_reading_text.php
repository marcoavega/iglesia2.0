...
if ($_POST['r'] == 'capture-lessons-edit-bible_reading_text' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-edit-bible_reading_text' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

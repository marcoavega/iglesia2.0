<?php
if ($_POST['r'] == 'capture-lessons-add-name_lesson' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
<div class="container">
	...
	', $date_select);
} else if ($_POST['r'] == 'capture-lessons-add-name_lesson' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

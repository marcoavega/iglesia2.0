...
if ($_POST['r'] == 'capture-lessons-delete-bible_reading' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-delete-bible_reading' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'del') {

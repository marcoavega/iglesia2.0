...
if ($_POST['r'] == 'capture-lessons-delete-question3' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-delete-question3' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'del') {

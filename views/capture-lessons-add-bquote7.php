<?php
if ($_POST['r'] == 'capture-lessons-add-bquote7' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-add-bquote7' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

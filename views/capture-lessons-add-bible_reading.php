<?php
if ($_POST['r'] == 'capture-lessons-add-bible_reading' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
<div class="row container">
	...
	', $name_lesson_select);
} else if ($_POST['r'] == 'capture-lessons-add-bible_reading' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

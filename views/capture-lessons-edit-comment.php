...
if ($_POST['r'] == 'capture-lessons-edit-comment' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
	...
	if (empty($cc)) {
		...
		$template_cc = '
			...
			<form method="POST" class="">
				...
				<div class="">
					<input type="text" name="comment" placeholder="Comentario" value="%s" required>
				</div>
				<div class="">
...
} else if ($_POST['r'] == 'capture-lessons-edit-comment' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

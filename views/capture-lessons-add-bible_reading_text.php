<?php
if ($_POST['r'] == 'capture-lessons-add-bible_reading_text' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
	...
	', $name_lesson_select);
} else if ($_POST['r'] == 'capture-lessons-add-bible_reading_text' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

<?php
if ($_POST['r'] == 'capture-lessons-add-trimester' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
<div class="container">
	...
	', $year_select);
} else if ($_POST['r'] == 'capture-lessons-add-trimester' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

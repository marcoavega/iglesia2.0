<?php
if ($_POST['r'] == 'capture-lessons-add-comment' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
<div class="container">
	...
	', $name_lesson_select);
} else if ($_POST['r'] == 'capture-lessons-add-comment' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {

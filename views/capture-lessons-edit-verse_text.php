...
if ($_POST['r'] == 'capture-lessons-edit-verse_text' && $_SESSION['role'] == 'admin' && !isset($_POST['crud'])) {
...
} else if ($_POST['r'] == 'capture-lessons-edit-verse_text' && $_SESSION['role'] == 'admin' && $_POST['crud'] == 'set') {
